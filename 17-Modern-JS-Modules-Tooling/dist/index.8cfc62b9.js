...
// Modifying the state to show deep cloning
state.user.loggedIn = false;
console.log(stateClone); // Shallow clone (modifies original object)
console.log(stateDeepClone); // Deep clone (original state remains intact)
// Using imported functions
const sum = (0, _shoppingCartJs.addition)(10, 5); // 15
const difference = (0, _shoppingCartJs.subtraction)(10, 5); // 5
console.log(`Sum: ${sum}`); // 15
console.log(`Difference: ${difference}`); // 5
// Using the discount and taxRate for calculation
const priceBeforeDiscount = 100;
const finalPrice = priceBeforeDiscount - (0, _shoppingCartJs.discount) + priceBeforeDiscount * (0, _shoppingCartJs.taxRate);
...
parcelHelpers.export(exports, "taxRate", ()=>taxRate);
